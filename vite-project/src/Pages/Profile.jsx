  ...
  return (
     ...
     <div className="bg-slate-50 h-screen w-screen">
           <div className="flex flex-row ">
            ...
            <div className="w-1/2 absolute top-1/6 right-20 left-50 flex flex-row justify-end px-14 py-0.5">
            <img src='https://i.postimg.cc/brzLQgZH/IMG-4989-removebg-preview-1.png' className="h-90 w-90 p-16"/>
            </div>
           </div>
        </div>
     </>
